...
export declare class User extends BaseResource implements UserResource {
    ...
    getOrganizationMemberships: (retrieveMembership: RetrieveMembershipsParams) => Promise<OrganizationMembership[]>;
