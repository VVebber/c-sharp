import type { AttemptEmailAddressVerificationParams, AttemptPhoneNumberVerificationParams, AttemptVerificationParams, AttemptWeb3WalletVerificationParams, AuthenticateWithRedirectParams, AuthenticateWithWeb3Params, CreateMagicLinkFlowReturn, PrepareEmailAddressVerificationParams, PreparePhoneNumberVerificationParams, PrepareVerificationParams, SignUpAuthenticateWithMetamaskParams, SignUpCreateParams, SignUpField, SignUpIdentificationField, SignUpJSON, SignUpResource, SignUpStatus, SignUpUpdateParams, StartMagicLinkFlowParams } from '@clerk/types';
...
export declare class SignUp extends BaseResource implements SignUpResource {
    ...
    authenticateWithRedirect: ({ redirectUrl, redirectUrlComplete, strategy, continueSignUp, unsafeMetadata, }: AuthenticateWithRedirectParams & {
