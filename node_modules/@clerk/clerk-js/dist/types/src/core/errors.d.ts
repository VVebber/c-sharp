...
export declare function clerkErrorInvalidColor(name: string): never;
export declare function clerkCoreErrorContextProviderNotFound(providerName: string): never;
export declare function clerkCoreErrorUserIsNotDefined(): never;
export declare function clerkCoreErrorSessionIsNotDefined(): never;
export declare function clerkCoreErrorOrganizationIsNotDefined(): never;
...
export declare function clerkCoreErrorTokenRefreshFailed(message: string): never;
