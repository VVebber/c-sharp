...
export declare const useUserButtonContext: () => {
    ...
    afterSwitchSessionUrl: string | undefined;
...
export declare const useOrganizationSwitcherContext: () => {
    ...
    navigateOrganizationProfile: () => any;
    navigateCreateOrganization: () => any;
    navigateAfterSwitchOrganization: () => any;
...
export declare const useOrganizationProfileContext: () => {
    navigateAfterLeaveOrganization: () => any;
...
export declare const useCreateOrganizationContext: () => {
    navigateAfterCreateOrganization: () => any;
