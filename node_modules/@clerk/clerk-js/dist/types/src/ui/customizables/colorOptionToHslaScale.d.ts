import type { ColorScale, CssColorOrScale, HslaColorString } from '@clerk/types';
...
export declare const colorOptionToHslaAlphaScale: <Prefix extends string>(colorOption: CssColorOrScale | undefined, prefix: Prefix) => WithPrefix<InternalColorScale<HslaColorString>, Prefix> | undefined;
