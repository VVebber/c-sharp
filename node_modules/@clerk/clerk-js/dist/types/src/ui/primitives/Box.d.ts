...
export declare const Box: React.ForwardRefExoticComponent<Pick<Partial<Record<"isOpen" | "isDisabled" | "hasError" | "isLoading" | "isActive", any>> & React.ClassAttributes<HTMLDivElement> & React.HTMLAttributes<HTMLDivElement> & {
    css?: import("../styledSystem/types").ThemableCssProp;
} & AsProp & {}, "key" | "as" | "isOpen" | "isDisabled" | "hasError" | "isLoading" | "isActive" | keyof React.HTMLAttributes<HTMLDivElement> | "css"> & React.RefAttributes<HTMLDivElement>>;
export {};
