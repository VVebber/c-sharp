...
export declare const CodeControl: React.ForwardRefExoticComponent<Pick<CodeControlProps, "length" | "values" | "errorText" | "isDisabled" | "isLoading" | "setValues" | "isSuccessfullyFilled"> & React.RefAttributes<{
    reset: any;
}>>;
export {};
