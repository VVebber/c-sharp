...
export declare const PoweredByClerkTag: React.MemoExoticComponent<React.ForwardRefExoticComponent<Pick<Pick<Partial<Record<"isOpen" | "isDisabled" | "hasError" | "isLoading" | "isActive", any>> & React.ClassAttributes<HTMLDivElement> & React.HTMLAttributes<HTMLDivElement> & {
