...
declare const ClerkInstanceContext: import("react").Context<{
    value: LoadedClerk;
...
declare const ClientContext: import("react").Context<{
...
declare const OrganizationContext: import("react").Context<{
    value: {
...
} | undefined>, useOrganizationContext: () => {
    organization: OrganizationResource | null | undefined;
    lastOrganizationInvitation: OrganizationInvitationResource | null | undefined;
    lastOrganizationMember: OrganizationMembershipResource | null | undefined;
};
export { ClientContext, useClientContext, OrganizationContext, useOrganizationContext, UserContext, useUserContext, SessionContext, useSessionContext, ClerkInstanceContext, useClerkInstanceContext, };
